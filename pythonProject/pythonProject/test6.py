import numpy as np
import cv2
from tensorflow.keras.models import load_model  # Changed from pickle
...
# Changed to load_model for .h5 file (assuming model_trained.p is a typo or .h5)
model = load_model("model_trained.h5")  # Adjust filename if necessary
...
while True:
    ...
    img_input = img.reshape(1, 32, 32, 1)  # Ensure 1 channel for grayscale
